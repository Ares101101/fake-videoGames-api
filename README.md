...
## Available Endpoints 📋
### [GET ALL VIDEO GAMES ]('https://fakeapigames.1.us-1.fl0.io/videoGames') 🚀

This endpoint is used to retrieve all available video games.

Fetching from the production API
```js 
fetch('https://fakeapigames.1.us-1.fl0.io/videoGames')
...
### [GET ALL PUBLISHERS ]('https://fakeapigames.1.us-1.fl0.io/videoGames/publishers') 📢 AND [GET ALL DEVELOPERS ]('https://fakeapigames.1.us-1.fl0.io/videoGames/developers') 👨‍💻
...
```js 
// API 
fetch('https://fakeapigames.1.us-1.fl0.io/videoGames/publishers')
.then(response => response.json())
.then(data => console.log(data));
...
```js 
// API 
fetch('https://fakeapigames.1.us-1.fl0.io/videoGames/developers')
.then(response => response.json())
.then(data => console.log(data));
...
### [GET BY ID]('https://fakeapigames.1.us-1.fl0.io/videoGames/56514712-a2d5-44a9-9b28-5bd930b487fe') 🔑
...
fetch(`https://fakeapigames.1.us-1.fl0.io/videoGames/${gameId}`)
  .then(response => response.json())
  .then(data => console.log(data));
```

### [POST NEW GAME]('https://fakeapigames.1.us-1.fl0.io/videoGames') 🆕🎮
...
```
### [POST NEW DEV AND PUB]('https://fakeapigames.1.us-1.fl0.io/videoGames/developers') 🆕🧑‍💻
...
```
### [UPGRADE VIDEO GAME BY ID]('https://fakeapigames.1.us-1.fl0.io/videoGames/56514712-a2d5-44a9-9b28-5bd930b487fe') 🕹️
```JS
// UUID
...
```
### [DELETE VIDEO GAME BY ID]('https://fakeapigames.1.us-1.fl0.io/videoGames/56514712-a2d5-44a9-9b28-5bd930b487fe') ❌
